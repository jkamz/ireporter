...
class DefaultRouterWithAPIViews(routers.DefaultRouter):
    """
    ...
    def get_default_base_name(self, viewset):
        ...
        original `get_default_base_name` code.
        """
        if issubclass(viewset, viewsets.ViewSetMixin):
            return super(DefaultRouterWithAPIViews,
                         self).get_default_base_name(viewset)

        return underscore(viewset.__name__)
    ...
    def get_urls(self):
        ...
        return super(DefaultRouterWithAPIViews, self).get_urls() + ret
